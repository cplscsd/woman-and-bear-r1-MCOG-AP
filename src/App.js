            ...
            <div className="slide-container">
                ...
                <div className="slide fade">
                    <div className="image-container">
                        ...
                        <div className="avatar-container">
                          ...
                          <p>Long ago in the far north, there lived a village of people known as a the Inuit. They lived on the shores of the icy Arctic. They depended upon the bounty of the salmon and seal and the creatures of the snow to feed themselves. All the young men were hunters and fishers.<span className='doneButton' id='done1' onClick={() => {this.toggle('s1'); this.hide('done1'); this.showNext()}}>Done</span></p>
                    ...
                    <div className="image-container">
                        ...
                        <div className="avatar-container">
                            ...
                            <div id="s2" className="speech2">
                              Even when the sea is iced over the shore can be visible. Use your finger to trace the shore in this picture.
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="slide fade">
                    <div className="image-container">
                        ...
                        <div className="avatar-container">
                            ...
                            <p>One cold winter day, the woman was walking by the sea when she <span className='highlight'>spotted</span> a tiny white polar bear sitting all alone on the thick ice. His mother was nowhere in sight. "Someone must have killed her," she said softly, and she walked onto the ice, picked up the cub and looked into his eyes. "You will be my son," she said. She called him Kunik.
                            </p>
                            <div id="s3" className="multiple">
                            Look again at the story. What does the word spotted mean in the story?
                            <div className='choice' id="3a" onClick={() => this.selectOption("3a", 3)}>(a) The bear was white with dark spots on his fur.</div>
                            <div className='choice' id="3b" onClick={() => this.selectOption("3b", 3)}>(b) The old woman noticed the bear. </div>
                            <div className='choice' id="3c" onClick={() => this.selectOption("3c", 3)}>(c) The bear's bright white fur looked speckled in the sun.</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="slide fade">
                    <div className="image-container">
                        ...
                        <div className="avatar-container">
                            ...
                            <p>The old woman took her cub back to her home. From that day on, she <span className='highlight'>shared</span> all her food with Kunik, and a strong bond grew between the two.
                            </p>
                            <div id="s4" className="speech2">
                              Do you share food with anyone in your family? A pet or a brother or sister?
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="slide fade">
                    <div className="image-container">
                        ...
                        <div className="avatar-container">
                            ...
                            <div className='choice' id="5a" onClick={() => this.selectOption("5a", 5)}>(a) She plays with the bear in the snow.</div>
                            <div className='choice' id="5b" onClick={() => this.selectOption("5b", 5)}>(b) The bear and the children entertain her all day.</div>
                            <div className='choice' id="5c" onClick={() => this.selectOption("5c", 5)}>(c) Kunik is gentle with the children.</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="slide fade">
                    <div className="image-container">
                        ...
                        <div className="avatar-container">
                            ...
                            The old woman is proud of Kunik's fishing skills. What can you do that makes your family proud?
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="image-container">
                        ...
                        <div className="avatar-container">
                            ...
                            <div id="s7" className="multiple">
                              ...
                              <div className='choice' id="7a" onClick={() => this.selectOption("7a", 7)}>(a) mean</div>
                              <div className='choice' id="7b" onClick={() => this.selectOption("7b", 7)}>(b) frightened</div>
                              <div className='choice' id="7c" onClick={() => this.selectOption("7c", 7)}>(c) jealous</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="slide fade">
                    <div className="image-container">
                        ...
                        <div className="avatar-container">
                            ...
                            The old woman is weeping because she is afraid for Kunik. What do you think will happen? 
                            </div>
                        </div>
                    </div>
                ...
                <div className="slide fade">
                    <div className="image-container">
                        ...
                        <div className="avatar-container">
                            <img className="avatar" src={avatar} alt="Owl avatar" onClick={() => {this.showNext(); this.toggleBlock('s9')}}/>
                            ...
                            Kunik obeyed his mother's wishes. Fill in the blank in this sentence so that it says the same thing with new words: Kunik <input className='input-word'/> his mother's instructions. 
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="image-container">
                        ...
                        <div className="avatar-container">
                            ...
                            <div id="s10" className="multiple">
                              Kunik brought food for his mother because he loves her. Which of these would you give to someone you love?
                ...
                <div className="slide fade">
                    <div className="image-container">
                        ...
                        <div className="avatar-container">
                            ...
                            Make sentences to show what happened first and what happened next. [show scrambled list of phrases to fill in the blanks] First the woman found the bear and then she was not lonely any more.First Kunik was small and then he became taller and smarter.First the woman shared her food with Kunik and then he brought her the biggest salmon.First the men were envious and afraid of Kunik and then they were proud and respected him.                            </div>
                        </div>
                    </div>
                </div>
